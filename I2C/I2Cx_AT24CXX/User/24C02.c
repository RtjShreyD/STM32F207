...
__IO uint32_t  I2CTimeout = I2C_Open207Z_LONG_TIMEOUT;
...
void I2C_Configuration(void)
{
	...
	RCC_AHB1PeriphClockCmd(Open207Z_I2Cx_SDA_GPIO_CLK | Open207Z_I2Cx_SCL_GPIO_CLK,ENABLE);
	
	RCC_APB1PeriphClockCmd(Open207Z_I2Cx_CLK,ENABLE);
	
	GPIO_PinAFConfig(Open207Z_I2Cx_SDA_GPIO_PORT, Open207Z_I2Cx_SDA_SOURCE, Open207Z_I2Cx_SDA_AF);
	GPIO_PinAFConfig(Open207Z_I2Cx_SCL_GPIO_PORT, Open207Z_I2Cx_SCL_SOURCE, Open207Z_I2Cx_SCL_AF);
	
	GPIO_InitStructure.GPIO_Pin =  Open207Z_I2Cx_SDA_PIN;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;
  	GPIO_InitStructure.GPIO_OType = GPIO_OType_OD;
  	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
	GPIO_Init(Open207Z_I2Cx_SDA_GPIO_PORT, &GPIO_InitStructure);

	GPIO_InitStructure.GPIO_Pin =  Open207Z_I2Cx_SCL_PIN;
	GPIO_Init(Open207Z_I2Cx_SCL_GPIO_PORT, &GPIO_InitStructure);
		
	I2C_DeInit(Open207Z_I2Cx);
	...
	I2C_Cmd(Open207Z_I2Cx, ENABLE);
	I2C_Init(Open207Z_I2Cx, &I2C_InitStructure);
	
	I2C_AcknowledgeConfig(Open207Z_I2Cx, ENABLE);
}
...
{
	I2CTimeout = I2C_Open207Z_LONG_TIMEOUT;
	...
	while(I2C_GetFlagStatus(I2Cx, I2C_FLAG_BUSY))
  	...
  	I2C_GenerateSTART(I2Cx, ENABLE);
	I2CTimeout = I2C_Open207Z_FLAG_TIMEOUT;
	while(!I2C_CheckEvent(I2Cx, I2C_EVENT_MASTER_MODE_SELECT))
	{
		if((I2CTimeout--) == 0) return I2C_TIMEOUT_UserCallback();
	}  

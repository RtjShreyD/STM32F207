	...
	switch(keyvulua)
		{
			...
			case 2:
			  	...
			  	Delay(0x1fffff);
				GUI_Text(132,0,"Key 'A' Pressed!",Black,White);
				break;
			case 3:
				...
				Delay(0x1fffff);
				GUI_Text(132,0,"Key 'B' Pressed!",Blue,White);
				break;
			case 4:
				GPIO_SetBits(LED1_Port , LED1_Pin);
			  	GPIO_SetBits(LED2_Port , LED2_Pin);
			  	...
			  	GPIO_ResetBits(LED4_Port , LED4_Pin);
			  	Delay(0x1fffff);
				GUI_Text(132,0,"Key 'C' Pressed!",Red,White);
				break;
			case 5:
				GPIO_SetBits(LED1_Port , LED1_Pin);
				Delay(0x1fffff);
				...
				Delay(0x1fffff);
				GPIO_ResetBits(LED2_Port , LED2_Pin);
				GUI_Text(132,0,"Key 'D' Pressed!",Green,White);

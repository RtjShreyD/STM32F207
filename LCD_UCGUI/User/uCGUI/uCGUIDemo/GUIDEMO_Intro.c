...
void GUIDEMO_Intro(void) {
  ...
  GUI_DispStringHCenterAt("Coretex M3 - Prototype Application"
                          , xCenter, y += 40);
  ...
  GUI_SetColor(GUI_WHITE);
  GUI_DispStringHCenterAt("F/W by S.Jung", LCD_GET_XSIZE() / 2, LCD_GET_YSIZE() - 40);
  GUI_DrawBitmap(&bmpns14539, (LCD_GET_XSIZE() - bmpns14539.XSize) / 2, 150);
  //(&bmMicriumLogo, (LCD_GET_XSIZE() - bmMicriumLogo.XSize) / 2, 150);//
  GUI_SetColor(GUI_WHITE);
  GUI_SetFont(&GUI_Font10S_ASCII);

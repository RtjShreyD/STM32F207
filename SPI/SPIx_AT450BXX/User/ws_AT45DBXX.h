...
#ifdef OpenSPI1
	#define Open207Z_SPIx_CS_PIN                   GPIO_Pin_4
	#define Open207Z_SPIx_CS_GPIO_PORT             GPIOA
	#define Open207Z_SPIx_CS_GPIO_CLK              RCC_AHB1Periph_GPIOA
#endif
#ifdef OpenSPI2
	#define Open207Z_SPIx_CS_PIN                   GPIO_Pin_12
	#define Open207Z_SPIx_CS_GPIO_PORT             GPIOB
	#define Open207Z_SPIx_CS_GPIO_CLK              RCC_AHB1Periph_GPIOB
#endif
#ifdef OpenSPI3
	#define Open207Z_SPIx_CS_PIN                   GPIO_Pin_4
	#define Open207Z_SPIx_CS_GPIO_PORT             GPIOA
...
#define AT45DBXX_Enable 	GPIO_ResetBits(Open207Z_SPIx_CS_GPIO_PORT,Open207Z_SPIx_CS_PIN);
#define AT45DBXX_Disable 	GPIO_SetBits(Open207Z_SPIx_CS_GPIO_PORT,Open207Z_SPIx_CS_PIN);
